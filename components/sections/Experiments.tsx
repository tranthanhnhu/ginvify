  ...
  return (
    ...
    >
      <Container>
        ...
        {visible.length === 0 ? (
          <div className="mt-16 flex flex-col items-center gap-6 border border-white/10 py-16 text-center">
          ...
          <ul className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {visible.map((item) => (
              <li key={item.title}>
                <article className="h-full border border-white/10 bg-bg-1/35 p-6">
